...
import {postApplication, getApplication, deleteApplication} from "../controllers/applications.controller.ts";

const router = Router();

router.post("/applications", requireAuthHeader, postApplication);
router.get("/applications", requireAuthHeader, getApplication);
