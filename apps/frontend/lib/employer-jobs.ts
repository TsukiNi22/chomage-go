...
export const employerJobPostings: EmployerJobPosting[] = [
    ...
    },
    {
        ...
        description: "Accompagnement des clients professionnels sur l'agence de Lyon.",
        contractType: "CDI",
        requiredSkills: ["Relation client", "CRM"],
        salaryMin: 27000,
        applicantsCount: 9,
    },
    {
        ...
        description: "Entretien et dépannage du parc de machines de production.",
        contractType: "CDD",
        requiredSkills: ["Électrotechnique", "Habilitation électrique"],
        salaryMin: 29500,
        applicantsCount: 5,
    },
    {
        ...
        description: "Animation des réseaux sociaux et suivi des campagnes publicitaires.",
        contractType: "Alternance",
        requiredSkills: ["SEO", "Réseaux sociaux"],
        salaryMin: 950,
        applicantsCount: 16,
    },
];
