    ...
    return (
        <section className="border-b border-border bg-wash px-6 py-16">
            <div className="mx-auto flex max-w-3xl flex-col items-center gap-6 text-center">
                <span className="border border-action-text/40 bg-background px-4 py-1.5 font-heading text-[0.7rem] font-semibold uppercase tracking-[0.14em] text-action-text">
                    Démonstrateur — recherche d&apos;emploi géolocalisée
                </span>
